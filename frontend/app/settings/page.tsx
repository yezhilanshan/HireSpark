...
import { Bell, ChevronRight, MoonStar, ShieldCheck, UserCircle2 } from 'lucide-react'
            ...
            <main className="flex-1 overflow-y-auto">
                <div className="mx-auto max-w-5xl px-6 py-8">
                    <section className="rounded-3xl border border-[#E5E5E5] bg-[#FAF9F6] p-8 shadow-sm">
                        <p className="text-xs font-medium uppercase tracking-[0.18em] text-[#999999]">系统设置</p>
                    ...
                    <section className="mt-6 grid gap-4 md:grid-cols-2">
                        ...
                        <SettingCard
                            icon={MoonStar}
                            title="外观与主题"
                            description={mounted ? '可在左侧栏底部即时切换明暗主题。' : '正在加载主题设置...'}
                            href="/"
                            actionText="返回工作台"
                        />
                        <SettingCard
