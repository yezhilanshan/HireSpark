    ...
    return (
        <div className="min-h-screen flex bg-[#FAF9F6]">
            <div className="hidden lg:flex flex-1 flex-col justify-between p-12 border-r border-[#E5E5E5] bg-[#F5F4F0]">
                <div>
                    <div className="text-xl font-serif italic font-medium text-[#111111]">HireSpark</div>
                </div>
                <div className="max-w-md">
                    ...
                    <p className="text-[#666666] text-lg leading-relaxed">
                        HireSpark provides a calm, intelligent environment to practice and perfect your professional communication.
                    </p>
                </div>
                <div className="text-sm text-[#999999]">© 2026 HireSpark</div>
            </div>

            <div className="flex-1 flex items-center justify-center p-8">
                <div className="w-full max-w-sm space-y-8">
                    <div className="text-center lg:text-left">
                        <h2 className="text-2xl font-medium text-[#111111] tracking-tight">Sign in to HireSpark</h2>
